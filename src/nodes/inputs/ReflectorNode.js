...
import { OperatorNode } from '../accessors/OperatorNode.js';
...
ReflectorNode.prototype.setMirror = function ( mirror ) {
	...
	this.localPosition = new PositionNode( THREE.PositionNode.LOCAL );

	this.coord = new OperatorNode( this.textureMatrix, this.localPosition, OperatorNode.MUL );
	this.coordResult = new OperatorNode( null, this.coord, THREE.OperatorNode.ADD );
