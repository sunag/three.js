...
import { NormalBlending, FrontSide } from '../../constants.js';

function NodeMaterial( vertex, fragment ) {

	ShaderMaterial.call( this );

	this.vertex = vertex/* || new RawNode( new THREE.PositionNode( THREE.PositionNode.PROJECTION ) )*/;
	this.fragment = fragment/* || new RawNode( new THREE.ColorNode( 0xFF0000 ) )*/;
