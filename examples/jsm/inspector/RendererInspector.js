...
import { AbstractInspector, TimestampQuery } from 'three/webgpu';
...
export class RendererInspector extends AbstractInspector {
	...
	updateStats( stats ) {
		...
		stats.gpu = this.renderer.backend.timestampQueryPool.render.getCurrentTimestamp( stats.uid ) || 0;
