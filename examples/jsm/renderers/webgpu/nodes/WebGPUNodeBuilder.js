...
fn w2( a : f32 ) -> f32 {
	...
	return ( 1.0 / 6.0 ) * ( ( a * ( a * ( ( - 3.0 * a ) + 3.0 ) + 3.0 ) ) + 1.0 );
		  //( 1.0 / 6.0 ) * ( ( a * ( a * ( ( - 3.0 * a ) + 3.0 ) ) ) + 1.0

}

fn w3( a : f32 ) -> f32 {

	return ( 1.0 / 6.0 ) * pow( a, 3 );
...
fn bicubic( img:  texture_2d<f32>, imgSampler: sampler, uv : vec2<f32>, texelSize : vec4<f32>, lod : f32 ) -> vec4<f32> {
...
fn textureBicubic( img:  texture_2d<f32>, imgSampler: sampler, uv : vec2<f32>,  lod : f32 ) -> vec4<f32> {
    ...
    let fSample = bicubic( img, imgSampler, uv, vec4( fLodSizeInv, fLodSize ), floor( lod ) );
	return fSample;
    //let cSample = bicubic( img, imgSampler, uv, vec4( cLodSizeInv, cLodSize ), ceil( lod ) );
